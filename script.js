    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Nexora AI uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '999837ba-2a07-4ad5-b903-e42c5dc56242',
                    name: data.name || '',
                    email: data.email || '',
